...
<body>
    ...
    <div class="container">
        ...
        <div class="footer" style="position: fixed; left: 0; bottom: 0; width: 100vw; background: rgba(34,37,47,0.96); color: #fff; text-align: center; padding: 14px 0 12px 0; font-size: 1.06em; font-family: Montserrat, Arial, sans-serif; z-index: 10; box-shadow: 0 -2px 12px #00397322;">
    Made with ❤️ in Brussels &nbsp;|&nbsp; made by
    <a href="https://www.consultantcloud.io" target="_blank" style="text-decoration:none;vertical-align:middle;">
        <img src="https://www.consultantcloud.io/assets/landing-page-theme/img/logo.png"
             alt="ConsultantCloud"
             style="height:1.2em;vertical-align:middle;margin:0 7px 0 8px;border-radius:5px;box-shadow:0 2px 8px #00397333;">
    </a>
